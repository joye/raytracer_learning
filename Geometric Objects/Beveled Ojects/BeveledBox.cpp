...
#include "Geometric Objects/Primitives/OpenCylinder.h"
#include "Geometric Objects/Primitives/Rectangle.h"
#include "Geometric Objects/Sphere.h"
#include "Geometric Objects/Instance.h"
...
BeveledBox::shadow_hit(const Ray& ray, double& tmin) const {
	if (bbox.hit(ray))
		//return (Compound::shadow_hit(ray, tmin)); need to be added
		return true;
	else
		return (false);
}
